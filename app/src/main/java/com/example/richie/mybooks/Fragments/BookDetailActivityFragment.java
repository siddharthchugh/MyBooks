...
import com.example.richie.mybooks.Activities.UpdateActivity;
...
public class BookDetailActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        detailView = inflater.inflate(R.layout.fragment_book_detail, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if(inDetail!=null&& inDetail.hasExtra(Intent.EXTRA_TEXT)) {
            ...
            receivedata = inDetail.getStringExtra(Intent.EXTRA_TEXT);
               ((TextView) getActivity().findViewById(R.id.book_Title)).setText(receivedata.toString());
 //      Toast.makeText(getContext(),receivedata.toString(),Toast.LENGTH_SHORT).show();
        }
